...
var Num_ = function (_a) {
    var decimal = _a.decimal, disabled = _a.disabled, id = _a.id, inputRef = _a.inputRef, label = _a.label, max = _a.max, min = _a.min, name = _a.name, onChange = _a.onChange, placeholder = _a.placeholder, step = _a.step, value = _a.value, props = tslib_1.__rest(_a, ["decimal", "disabled", "id", "inputRef", "label", "max", "min", "name", "onChange", "placeholder", "step", "value"]);
